...
# data = scrape(words=['bitcoin'], since="2020-1-1", until="2022-4-14", from_account=None, interval=1,
#               headless=False, display_type="Top", save_images=False, lang="cn",
...
data = scrape(hashtag="bitcoin", since="2020-3-1", until="2020-4-14", from_account=None, interval=1,
