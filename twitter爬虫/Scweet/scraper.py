...
my_users = data
print(my_users[:10])
for username in my_users[:10]:
    data = scrape(words=None, since="2010-8-10", until="2023-8-11", from_account=None, interval=1,
    ...
    data.to_csv("UserPosts/{}UserData.csv".format(username))
