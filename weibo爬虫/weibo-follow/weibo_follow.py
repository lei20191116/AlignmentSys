    ...
    def deal_html(self, url):
        ...
        try:
            ...
            headers = {
                ...
                'Cookie': "SCF=AujJP-0jBMKic1zJAhHoPtoc-JpI8TsiTpTg04MU_h12KDcpxLJSRU0rHHdHJtxNcLWR9yUiUcAdFhDGyifOp_0.; SUB=_2A25IOK4dDeRhGeFI61YQ9C7JzT6IHXVrwjJVrDV6PUNbktANLRnXkW1NfXoyKZ5DJk3e-YO5v83ThL7DNVYs61KI; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9Whn_lUNQ4qbcIhn4-p.DvaN5JpX5KMhUgL.FoMcehBpSh5fSoz2dJLoI7D4qPLDwgYpeoec; SSOLoginState=1698487885; ALF=1701079885; _T_WM=200718b690ce5368351fea4b20846ac2"}
    ...
    def get_one_page(self, page):
        ...
        if (page == 1 and len(table_list) == 0):
            ...
            for t in table_list:
                ...
                if {'uri': uri} not in self.follow_list:
                    self.follow_list.append({'uri': uri})
                    self.UID_list.append(uri)
                    print(u' %s' % ( uri))
